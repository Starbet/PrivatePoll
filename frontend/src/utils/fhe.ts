...
export async function decryptVote(
  ...
  // Convert to boolean: 1 = yes (true), 0 = no (false)
  const voteBoolean = Number(decryptedValue) === 1;
  
  console.log("✅ Vote decrypted:", voteBoolean ? "YES" : "NO");
  return voteBoolean;
}
